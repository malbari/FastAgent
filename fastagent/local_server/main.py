...
from fastagent.local_server.utils import AccessibilityHelper, ScreenshotHelper
from fastagent.local_server.platform_adapters import get_platform_adapter
from fastagent.local_server.health_checker import HealthChecker
from fastagent.local_server.feature_checker import FeatureChecker
...
def health_check():
    ...
    return jsonify({
        'status': 'ok',
        'service': 'FastAgent Desktop Server',
        'version': '1.0.0',
...
def print_banner(host: str = "127.0.0.1", port: int = 5000, debug: bool = False):
    ...
    from fastagent.utils.display import print_banner as display_banner, print_section, print_separator, colorize
    
    # STARTUP INFORMATION
    display_banner("FastAgent · Local Server")
