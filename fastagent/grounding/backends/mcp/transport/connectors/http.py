...
from fastagent.grounding.core.transport.task_managers.base import BaseConnectionManager
from fastagent.grounding.backends.mcp.transport.task_managers import SseConnectionManager, StreamableHttpConnectionManager
from fastagent.grounding.backends.mcp.transport.connectors.base import MCPBaseConnector, DEFAULT_TOOL_CALL_MAX_RETRIES, DEFAULT_TOOL_CALL_RETRY_DELAY
...
class HttpConnector(MCPBaseConnector):
    ...
    def __init__(
        ...
        from fastagent.grounding.core.transport.task_managers import PlaceholderConnectionManager
        ...
        async with httpx.AsyncClient(timeout=httpx.Timeout(self.timeout), headers=headers) as client:
            payload = {
                ...
                "params": {
                    ...
                    "capabilities": {},
                    "clientInfo": {"name": "FastAgent", "version": "1.0.0"},
                }
            }
